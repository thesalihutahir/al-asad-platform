...
// --- INTERNAL COMPONENT: HANDLING LOGIC ---
function LoginContent() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // Force logout if verification failed
            await signOut(auth);
...
export default function AdminLoginPage() {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#f8f5f0] relative overflow-hidden px-4">
            ...
            <Suspense fallback={
                <div className="relative z-10 p-8 bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-[#d17600]/10">
                    <Loader2 className="w-10 h-10 animate-spin text-[#432e16]" />
                </div>
            }>
                <LoginContent />
            </Suspense>
