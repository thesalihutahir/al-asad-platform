    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto pb-12">
            ...
            <div className="flex items-center gap-4 py-4 border-b border-gray-200">
                ...
                <div>
                    <h1 className="font-agency text-3xl text-brand-brown-dark">Create Audio Series</h1>
                    <p className="font-lato text-sm text-gray-500">Group related audio tracks into a playlist/album.</p>
                </div>
            </div>
