            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 sticky top-0 bg-gray-50 z-20 py-4 border-b border-gray-200">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="font-lato text-sm text-gray-500">Launch a new initiative or community project.</p>
                    </div>
                </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <input 
                            ...
                            placeholder="e.g. Rural Water Supply Project" 
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <textarea 
                            ...
                            onChange={handleChange}
                            rows="2"
                            placeholder="Brief description for the programs listing page..." 
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 min-h-[400px] flex flex-col">
                        ...
                        <textarea 
                            ...
                            placeholder="Describe the program goals, implementation strategy, and expected impact..."
                        ></textarea>
                    </div>
                </div>
