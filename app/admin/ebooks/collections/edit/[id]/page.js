...
export default function EditCollectionPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const collectionRef = doc(db, "ebook_collections", id);
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto pb-12">
            ...
            <div className="flex items-center gap-4 py-4 border-b border-gray-200">
                ...
                <div>
                    <h1 className="font-agency text-3xl text-brand-brown-dark">Edit Collection</h1>
                    <p className="font-lato text-sm text-gray-500">Update collection details.</p>
                </div>
            </div>
                ...
                <div>
                    ...
                    {originalTitle !== formData.title && (
                        <p className="text-[10px] text-orange-600 mt-1 font-bold">
                            Note: Changing the title will automatically update all linked books.
                        </p>
                    )}
                </div>
