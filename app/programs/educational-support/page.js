    ...
    return (
        <div className="min-h-screen flex flex-col bg-white font-lato text-brand-brown-dark">
            ...
            <main className="flex-grow pb-16">
                ...
                <section className="relative h-[60vh] min-h-[500px] w-full flex items-center justify-center overflow-hidden bg-black mb-20">
                    <Image
                        ...
                        priority
                    />
                    {/* Darker Gradient Overlay for Maximum Text Pop */}
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-black/30"></div>
                    
                    <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/30 bg-white/10 backdrop-blur-md text-brand-gold text-xs font-bold uppercase tracking-widest mb-6 shadow-lg">
                        ...
                        <p className="font-lato text-white text-lg md:text-2xl max-w-3xl mx-auto leading-relaxed font-light drop-shadow-md opacity-95">
                ...
                <section className="px-6 my-24">
                    <div className="max-w-5xl mx-auto bg-brand-brown-dark rounded-[3rem] p-10 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
                        {/* Background Deco */}
