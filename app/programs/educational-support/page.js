            ...
            <main className="flex-grow pb-16">
                ...
                <section className="w-full relative bg-brand-brown-dark mb-12 md:mb-20">
                    ...
                    <div className="relative -mt-16 md:-mt-32 text-center px-6 z-10 max-w-4xl mx-auto">
                        ...
                        <div className="w-16 md:w-24 h-1 bg-brand-gold mx-auto rounded-full mb-6 shadow-sm"></div>
                        <p className="font-lato text-white/90 text-sm md:text-xl max-w-2xl mx-auto leading-relaxed font-medium drop-shadow-md">
