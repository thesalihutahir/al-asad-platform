    ...
    <main className="bg-brand-sand min-h-screen">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          <h1 className="font-agency text-5xl md:text-7xl text-white uppercase tracking-tight">
      ...
      <section className="container mx-auto px-6 py-16 text-center">
        ...
        <p className="font-lato text-brand-brown max-w-3xl mx-auto leading-relaxed text-lg">
          We believe that spiritual growth flourishes in a stable environment. Our development work 
          focuses on basic community needs such as clean water, health services, and food security 
          so that students and families can focus on growth and learning without hardship.
        </p>
      </section>
      ...
      <section className="container mx-auto px-6 py-12">
        <div className="flex justify-between items-end mb-10">
          <h3 className="font-agency text-3xl text-brand-brown-dark uppercase">
            Current Projects
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h4 className="font-agency text-2xl text-brand-brown-dark mb-2">
                  {project.title}
                </h4>
      ...
      <section className="container mx-auto px-6 mt-12 mb-24">
        <div className="bg-brand-brown-dark rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h3 className="font-agency text-3xl text-white uppercase mb-2">
              Partner With Us in Development
            </h3>
            <p className="font-lato text-gray-300">
              We collaborate with NGOs and community leaders for measurable impact.
            </p>
          </div>

          <Link 
            href="/get-involved/partner-with-us"
            className="whitespace-nowrap bg-brand-gold text-white font-bold px-8 py-4 rounded-full hover:scale-105 transition-all"
          >
            Become a Partner
          </Link>
        </div>
