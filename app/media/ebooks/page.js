...
import { Book, Download, Library, Filter, ArrowRight } from 'lucide-react';

export default function EbooksPage() {

    // Mock Data for Book Collections (Series)
    const collections = [
        {
            id: 'tafsir-volumes',
            title: "Tafsir Volumes (1-10)",
            count: 10,
            image: "/hero.jpg", // Cover of Vol 1
        },
        {
    ...
    const books = [
        ...
        {
            id: 2,
            title: "Kitab At-Tawheed (Hausa Translation)",
            author: "Sheikh Muneer Ja'afar",
            language: "Hausa",
            size: "1.8 MB",
            cover: "/hero.jpg", 
        ...
        {
            id: 3,
            title: "Guide to Daily Adhkar & Duas",
        ...
        {
            id: 4,
            title: "Understanding Zakat in Modern Wealth",
            author: "Sheikh Muneer Ja'afar",
            language: "English",
            size: "1.2 MB",
            cover: "/hero.jpg", 
        ...
        {
            id: 5,
            title: "The Rights of the Spouse",
    ...
    return (
        <div className="min-h-screen flex flex-col bg-white font-lato">
            ...
            <main className="flex-grow pb-16">
                ...
                {/* 4. BOOK GRID (Mobile: 2 Col / Desktop: 5 Col) */}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-x-4 gap-y-8 md:gap-x-8 md:gap-y-12">
                        {books.map((book) => (
                            <div key={book.id} className="group flex flex-col items-start cursor-pointer">
                                ...
                                {/* Book Cover Card */}
                                <div className="relative w-full aspect-[2/3] bg-gray-100 rounded-lg md:rounded-xl overflow-hidden shadow-md mb-4 transition-all duration-300 group-hover:-translate-y-2 group-hover:shadow-2xl">
                                    <Image
                                        src={book.cover}
                                        alt={book.title}
                                        fill
                                    ...
                                    <div className="absolute inset-0 bg-brand-brown-dark/80 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center gap-3 backdrop-blur-[1px]">
