                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            {loadingProjects ? (
                                ...
                                <div className="p-6 bg-white rounded-2xl border border-gray-200 text-center">
                                    <p className="text-gray-500 mb-4">No specific campaigns active right now.</p>
                                    <button
                                        onClick={() => setSelectedProject({ id: 'general', title: 'General Fund', description: 'Used where needed most.' })}
                                        className="px-6 py-2 bg-brand-brown-dark text-white rounded-lg text-sm font-bold"
                                    >
